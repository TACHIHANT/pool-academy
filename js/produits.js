const produits = [
  {
    ...
    description: 'Tout ce que vous devez savoir pour une eau cristalline toute l\'année : pH, chlore, stabilisant, et bien plus.',
    prix: 14.99,
  ...
  },
  {
    ...
    description: 'Eau verte, algues, eau trouble, mauvaises odeurs — diagnostic et solutions étape par étape.',
    prix: 12.99,
    badge: 'Nouveau',
    couleur: '#059669',
  ...
  },
  {
    ...
    description: 'Guide complet pour l\'hivernage, la remise en route printanière et l\'entretien été/hiver.',
    prix: 11.99,
    badge: 'Populaire',
    couleur: '#7c3aed',
  ...
  },
  {
    ...
    description: 'Filtration, pompe, chauffage, robot — choisir, installer et entretenir chaque équipement.',
    prix: 13.99,
    badge: null,
    couleur: '#d97706',
