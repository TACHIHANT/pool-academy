(function() {
  ...
  if (window.location.pathname.includes('merci.html')) return;
  const overlay = document.createElement('div');
  overlay.id = 'lead-overlay';
  overlay.innerHTML = '<div class="lead-modal"><button class="lead-close" onclick="closeLead()">&times;</button><div class="lead-content"><div style="font-size:3rem;color:#0ea5e9;margin-bottom:0.5rem;"><i class="fas fa-gift"></i></div><h3>Recevez votre guide gratuit</h3><p style="color:#64748b;margin:0.5rem 0 1.5rem;">"Les 5 erreurs qui ruinent votre piscine" — offert !</p><div style="background:#f0f9ff;border-radius:8px;padding:0.75rem;margin-bottom:1.25rem;font-size:0.85rem;color:#0c4a6e;text-align:left;"><div style="display:flex;align-items:center;gap:0.5rem;padding:0.2rem 0;"><i class="fas fa-check-circle" style="color:#10b981;font-size:0.8rem;"></i> Guide PDF immédiat</div><div style="display:flex;align-items:center;gap:0.5rem;padding:0.2rem 0;"><i class="fas fa-check-circle" style="color:#10b981;font-size:0.8rem;"></i> Sans engagement</div><div style="display:flex;align-items:center;gap:0.5rem;padding:0.2rem 0;"><i class="fas fa-check-circle" style="color:#10b981;font-size:0.8rem;"></i> Désabonnement 1 clic</div></div><form id="lead-form"><input type="hidden" name="sujet" value="Newsletter - Guide gratuit"><input type="email" name="email" placeholder="Votre email" required style="width:100%;padding:0.75rem;border:2px solid #e2e8f0;border-radius:10px;margin-bottom:0.75rem;font-size:1rem;"><button type="submit" class="btn btn-blue btn-block" id="lead-submit"><i class="fas fa-download"></i> Recevoir le guide gratuit</button></form><p style="font-size:0.7rem;color:#94a3b8;margin-top:0.75rem;" id="lead-status">Votre email ne sera jamais partagé.</p></div></div>';
